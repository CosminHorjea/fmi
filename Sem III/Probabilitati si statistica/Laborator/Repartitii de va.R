...
# dgeom(x,p)
dgeom(5,0.4)
#probabilitatea ca primul succes sa se realizeze la a-6-a incercare (am aruncat de 5 ori)
#deci numara esecurile pana la primul succes
plot(0:10,dgeom(0:10,0.4))

#dbinom(x,n,p)
dbinom(3,5,0.4)
#probabilitatea ca din 5 incercari independente cu prob de succes 0.4 sa avem 3 succese
...
plot(0:30, dbinom(0:100,100,0.1),type="o")
