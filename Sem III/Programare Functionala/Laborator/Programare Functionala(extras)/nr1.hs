...
table1 =
  Table
    [Empty, One, Two, One, Empty, Empty, Two, One]
...
table2 =
  Table
    [Two, One, Two, One, Empty, Empty, Two, One]
    [Two, Empty, One, Two, One, Two, One, Two]
    [Two, Two, One, Empty, Empty, One, Two, One]
...
table3 =
  Table
    [Empty, One, Empty, Empty, Empty, Empty, Two, One]
    [Two, Empty, One, Two, One, Two, One, Two]
...
table4 =
  Table
    [Empty, Empty, Two, One, Empty, Empty, Two, One]
    [Two, One, One, Two, One, Two, One, Two]
    [Two, Two, One, Empty, Empty, One, Two, One]

-- validTable :: Table -> Bool
validTable (Table l1 l2 l3) =(and (map (\x -> (length x) == 8) [l1, l2, l3])) &&   length( filter(\x -> x) (([c==One | c<-l1++l2++l3 ]))) <= 9 && (length( filter(\x -> x) (([c==Two | c<-l1++l2++l3 ]))) <= 9)
-- 
...
move (Table l1 l2 l3) (P (x1, y1))(P (x2, y2))= x1+y1
