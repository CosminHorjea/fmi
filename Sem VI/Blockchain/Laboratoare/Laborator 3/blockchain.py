...
# calcularea hash-ului pentru a adauga blocurilor amprente digitale
import hashlib
import json                      # pentru stocarea datelor in blockchain
# utilizam si putin Flask pentru crearea aplicatiei web si jsonify pentru afisarea blockchain-ului
...
class UB_FMI_Blockchain:
    ...
    def verificaValidateLant(self, chain):
        ...
        while block_index < len(chain):
            ...
            # prooful anterior care se obtine pentru blocul anterior
            # care are proof asignat elementului proof
            proofAnterior = blocAnterior['proof']
            # prooful actual al blocului din lant
