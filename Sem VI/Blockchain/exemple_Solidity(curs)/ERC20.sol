...
contract ERC20{
    ...
    string public name = 'Token optional';               
    ...
    function transfer(address receiver, uint tokens) public checkBalance (msg.sender, tokens)  returns (bool) {
    ...
    function transferFrom(address from, address to, uint tokens) 
        ...
        spendlimit[from][msg.sender] = balances[from] - tokens;
